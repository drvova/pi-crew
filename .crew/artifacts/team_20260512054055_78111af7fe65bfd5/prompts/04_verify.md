...
Task ID: 04_verify
Task cwd: /home/bom/source/my_pi/pi-crew/.crew/worktrees/team_20260512054055_78111af7fe65bfd5/04_verify
...
.
  ...
  - test/
    - unit/
      ...
      - … 235 more
      - async-runner.test.ts  4.8KB  just now
    - integration/
...
```json
{
  "objective": "Verify completion for: Implement pi-debug extension. Read SPEC.md at /home/bom/source/my_pi/docs/extensions/pi-debug/SPEC.md. Create /home/bom/source/my_pi/pi-debug/ with ALL files. DAP client (JSON-RPC over stdio/TCP), breakpoints, stack traces, variable inspection, step control. Tools: debug_start, debug_stop, debug_breakpoint, debug_continue, debug_stack, debug_variables, debug_evaluate. Adapter registry. Unit tests required.\nRun tests ONCE (cache to .crew/cache/), read changed files from executor context. Cross-reference test output with the changes. Do NOT re-run tests. Give PASS or FAIL with specific test evidence.",
  "scope": "workspace",
  "repo": "pi-crew",
  "worktree": "/home/bom/source/my_pi/pi-crew/.crew/worktrees/team_20260512054055_78111af7fe65bfd5/04_verify",
...
Task:
Verify completion for: Implement pi-debug extension. Read SPEC.md at /home/bom/source/my_pi/docs/extensions/pi-debug/SPEC.md. Create /home/bom/source/my_pi/pi-debug/ with ALL files. DAP client (JSON-RPC over stdio/TCP), breakpoints, stack traces, variable inspection, step control. Tools: debug_start, debug_stop, debug_breakpoint, debug_continue, debug_stack, debug_variables, debug_evaluate. Adapter registry. Unit tests required.
Run tests ONCE (cache to .crew/cache/), read changed files from executor context. Cross-reference test output with the changes. Do NOT re-run tests. Give PASS or FAIL with specific test evidence.
