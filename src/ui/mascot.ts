...
export type MascotEffect = "random" | "none" | "typewriter" | "scanline" | "rain" | "fade" | "crt" | "glitch" | "dissolve";
...
const ARMIN_BITS: readonly number[] = [
	,
...
const NON_NONE_EFFECTS: MascotEffect[] = ["typewriter", "scanline", "rain", "fade", "crt", "glitch", "dissolve"];
...
export class AnimatedMascot {
	...
	private applyCatEffect(lines: readonly string[]): string[] {
		...
		if (this.effect === "scanline") {
			...
			return lines.map((ln, i) => (i === scanRow ? this.theme.bold(this.theme.fg("accent", ln)) : ln));
		}
