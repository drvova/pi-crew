...
Run ID: team_20260515161739_7343b9db906e1481
Team: fast-fix
Workflow: fast-fix
State root: /home/bom/.pi/agent/extensions/pi-crew/state/runs/team_20260515161739_7343b9db906e1481
Artifacts root: /home/bom/.pi/agent/extensions/pi-crew/artifacts/team_20260515161739_7343b9db906e1481
Events path: /home/bom/.pi/agent/extensions/pi-crew/state/runs/team_20260515161739_7343b9db906e1481/events.jsonl
Task ID: 03_verify
Task cwd: /tmp/pi-crew-resume-checkpoint-y4XtH2
...
```json
{
  ...
  "scope": "workspace",
  "repo": "pi-crew-resume-checkpoint-y4XtH2",
...
## 02_execute (executor)
Status: completed
Result artifact: /home/bom/.pi/agent/extensions/pi-crew/artifacts/team_20260515161739_7343b9db906e1481/results/02_execute.txt

Mock JSON success for executor

Artifacts produced: prompts/02_execute.md, results/02_execute.txt, metadata/02_execute.inputs.json, metadata/02_execute.coordination-bridge.md, metadata/02_execute.skills.md, metadata/02_execute.task-packet.json, metadata/02_execute.verification.json, metadata/02_execute.startup-evidence.json, metadata/02_execute.permission.json, metadata/02_execute.capabilities.json, metadata/02_execute.prompt-pipeline.json, metadata/02_execute.output-validation.json, shared/02_execute.md, logs/02_execute.log, transcripts/02_execute.jsonl

Usage: 10 input tokens, 5 output tokens, 25ms
</dependency-context>
